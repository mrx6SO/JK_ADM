...
!(function (a) {
    ...
    feather.replace(),
        ...
        a(document).on("click", ".navigation-toggler > a", function () {
            return (
                i.hasClass("small-navigation")
                    ? (i.removeClass("small-navigation"),
                      a(".navigation").niceScroll(),
                    ...
                    : i.hasClass("hidden-navigation") || n.width() < 1200
                    ? (a.createOverlay(),
                      a(".navigation").addClass("open"),
                      a(".navigation").on("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function (e) {
                          a(".navigation").niceScroll().resize();
                      }),
                      a('[data-toggle="dropdown"]').dropdown("hide"))
                    : (i.addClass("small-navigation"),
                      a(".navigation").getNiceScroll().remove(),
                      a(".navigation .navigation-menu-body > ul > li").each(function () {
                          a(this).find("> a").next("ul").length
                              ? a(this)
                                    .find("> a")
                                    .next("ul")
                                    .prepend('<li class="dropdown-divider">' + a(this).find("> a > span:not(.badge)").text() + "</li>")
                              : (a(this).find("> a").attr("title", a(this).find("> a > span:not(.badge)").text()), a(this).find("> a").tooltip({ placement: "right" }));
                      })),
                !1
            );
        }),
        ...
        n.on("load", function () {
            setTimeout(function () {
                a(".navigation .navigation-menu-body ul li a").each(function () {
                    var e = a(this);
                    e.next("ul").length && e.append('<i class="sub-menu-arrow far fa-angle-down"></i>');
                }),
    ...
    var o,
        s = a(".table-responsive");
    if (
        (s.on("show.bs.dropdown", function (e) {
        ...
        a(document).on("click", ".navigation ul li a", function () {
            ...
            if (e.next("ul").length) {
                ...
                return (
                    ...
                    !i.hasClass("horizontal-side-menu") &&
                        1200 <= n.width() &&
        ...
        a("body.icon-side-menu .navigation").hover(
            function (e) {},
            function (e) {
